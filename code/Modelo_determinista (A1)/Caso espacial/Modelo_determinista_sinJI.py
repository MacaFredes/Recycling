...
w = m.addVars(I,J, vtype=GRB.BINARY, lb = 0) #Auxiliar de si el sitio i decidió utilizar el sitio de reciclaje j.
...
m.setParam(GRB.Param.TimeLimit, 140)
...
#     for i in I:
#         if w[i,j].x != 0:
#             print("El sitio", i, "decidió utilizar el sitio de reciclaje",j, "valor", w[i,j].x)
